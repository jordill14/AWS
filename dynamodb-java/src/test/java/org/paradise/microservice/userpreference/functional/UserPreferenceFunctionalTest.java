...
public class UserPreferenceFunctionalTest extends AbstractFunctionalTest {
    ...
    public void shouldThrowErrorWithoutPreferencesInBody() throws Exception {
        ...
        .assertThat()
                ...
                .body("errors[0].default_message", equalTo("may not be null"))
                .body("errors[0].object_name", equalTo("userPreferences"))
                .body("errors[0].field", equalTo("preferences"))
                .body("errors[0].rejected_value", equalTo(null))
                .body("errors[0].binding_failure", equalTo(Boolean.FALSE))
